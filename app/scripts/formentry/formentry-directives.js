...
formEntry
  ...
  .directive('patientDemographics', [function () {
    return {
      ...
      templateUrl: "views/formentry/patient-demographics.html",
    }
  }])
  ...
  .directive('clinicLocationsDropdown', ['LocationService', function () {
    return {
      ...
      templateUrl: "views/formentry/locations.html",
    }
  }])
  ...
  .directive('outreachProvidersDropdown', ['DefaulterCohortService', function (DefaulterCohortService) {
    return {
      ...
      templateUrl: "views/formentry/outreachProvidersDropdown.html",
    }
  }])
      ...
      return {
        ...
        link: function (scope, element, attrs, ctrl, transclude) {
          ...
          function loadExistingEncounter(restEncounter) {
            ...
            scope.form.encounter = {
              uuid: restEncounter.uuid,
